...
Route::prefix('v1/')->group(function () {
    ...
    Route::post('/confirmCode',[\App\Http\Controllers\api\V1\Auth\AuthController::class,'confirm']);
    ...
    Route::get('/verifyCode',[\App\Http\Controllers\api\V1\Auth\AuthController::class,'verify']);
});
